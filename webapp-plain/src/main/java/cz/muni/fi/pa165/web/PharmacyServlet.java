...
public class PharmacyServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        log.debug("pharmacy servlet called by HTTP POST, drugname={} drugamount={} vendor={}", name, amount, vendor);
    ...
    public void init() {
        ...
        drugs.add(new Drug("Celaskon","500mg", "Pharmacy"));
        drugs.add(new Drug("Aspirin", "30mg", "Pharmacy"));
    }
